...
// Ikon bisa disesuaikan berdasarkan tipe (warning, success, info)
...
function ConfirmationModal({ isOpen, onCancel, onConfirm, title, message }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm mx-4" data-aos="fade-up" data-aos-duration="300">
